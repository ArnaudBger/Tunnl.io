...
import { View, StyleSheet, Dimensions, Modal, Text, TouchableOpacity, ActivityIndicator } from "react-native";
...
export default function Notifications({wallet, pk}
        ...
        const startDemo = async () => {
            try {
                ...
                setIsTransactionLoading(true); // Start loading indicator
                ...
                setIsTransactionLoading(false); // Stop loading indicator once transaction is done
            ...
            >   
                {isTransactionLoading ? (
                    <View style={styles.loadingContainer}>
                        ...
                        <Text style={styles.loadingText}>Creating a deal for demo purpose...</Text>
                    </View>
                ) : !isDemoEnded ? (
